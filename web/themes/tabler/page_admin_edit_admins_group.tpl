    ...
    <div id="admin-page-content">
        <div id="add-group">
            ...
            <table width="90%" border="0" style="border-collapse:collapse;" id="group.details" cellpadding="3">
                <tr>
                    <td valign="middle"><div class="rowdesc"><span class="text-info cursor-help me-1" data-bs-toggle="tooltip" data-bs-placement="right" title="Choose the group you want this admin to appear in for web permissions"><i class="fas fa-circle-question icon"></i></span> Web Admin Group</div></td>
                    <td>
                ...
                <tr>
                    <td valign="middle"><div class="rowdesc"><span class="text-info cursor-help me-1" data-bs-toggle="tooltip" data-bs-placement="right" title="Choose the group you want this admin to appear in for server admin permissions"><i class="fas fa-circle-question icon"></i></span> Server Admin Group </div></td>
