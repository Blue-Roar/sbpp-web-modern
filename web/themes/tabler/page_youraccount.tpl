<div id="admin-page-content">
    ...
    <div class="tabcontent" id="Change Password"> <!-- div ID 1 is the second 'panel' to be shown -->
        ...
        <table width="90%" border="0" style="border-collapse:collapse;" id="group.details" cellpadding="3">
            <tr>
                <td valign="top" width="35%"><div class="rowdesc">-<span class="text-info cursor-help me-1" data-bs-toggle="tooltip" data-bs-placement="right" title="We need to know your current password to verify its you."><i class="fas fa-circle-question icon"></i></span>-Current Password</div></td>
                <td><div align="left">
            ...
            <tr>
                <td valign="top"><div class="rowdesc">-<span class="text-info cursor-help me-1" data-bs-toggle="tooltip" data-bs-placement="right" title="Type your new password here. <br /><br /><i>Min Length: $min_pass_len</i>"><i class="fas fa-circle-question icon"></i></span>-New Password</div></td>
                <td><div align="left">
            ...
            <tr>
                <td valign="top"><div class="rowdesc">-<span class="text-info cursor-help me-1" data-bs-toggle="tooltip" data-bs-placement="right" title="Please type your new password again to avoid a mistake."><i class="fas fa-circle-question icon"></i></span>-Confirm Password</div></td>
                <td><div align="left">
            ...
            <tr>
                <td>&nbsp;</td>
                <td>
                    <button type="submit" onclick="xajax_CheckPassword(-{$user_aid}-, $('current').value);dispatch();" name="button" class="btn ok" id="button" value="Save"></button>
                    <button type="submit" onclick="history.go(-1)" name="button" class="btn cancel" id="button" value="Cancel"></button>
                </td>
            </tr>
        </table>
    </div>
    ...
    <div class="tabcontent" id="Server Password"> <!-- div ID 2 is the third 'panel' to be shown -->
        ...
        <table width="90%" border="0" style="border-collapse:collapse;" id="group.details" cellpadding="3">
            -{if $srvpwset}-
            <tr>
                <td valign="top" width="35%"><div class="rowdesc">-<span class="text-info cursor-help me-1" data-bs-toggle="tooltip" data-bs-placement="right" title="We need to know your current password to verify its you."><i class="fas fa-circle-question icon"></i></span>-Current Server Password</div></td>
                <td><div align="left">
            ...
            -{/if}-
            <tr>
                <td valign="top"><div class="rowdesc">-<span class="text-info cursor-help me-1" data-bs-toggle="tooltip" data-bs-placement="right" title="Type your new server password here. <br /><br /><i>Min Length: $min_pass_len</i>"><i class="fas fa-circle-question icon"></i></span>-New Password</div></td>
                <td><div align="left">
            ...
            <tr>
                <td valign="top"><div class="rowdesc">-<span class="text-info cursor-help me-1" data-bs-toggle="tooltip" data-bs-placement="right" title="Please type your new server password again to avoid a mistake."><i class="fas fa-circle-question icon"></i></span>-Confirm Password</div></td>
                <td><div align="left">
            ...
            -{if $srvpwset}-
            <tr>
                <td valign="top"><div class="rowdesc">-<span class="text-info cursor-help me-1" data-bs-toggle="tooltip" data-bs-placement="right" title="Check this box, if you want to delete your server password"><i class="fas fa-circle-question icon"></i></span>-Remove Password</div></td>
                <td><div align="left">
    ...
    <div class="tabcontent" id="Change Email"> <!-- div ID 3 is the fourth 'panel' to be shown -->
        ...
        <table width="90%" border="0" style="border-collapse:collapse;" id="group.details" cellpadding="3">
            <tr>
                <td valign="top"><div class="rowdesc">-<span class="text-info cursor-help me-1" data-bs-toggle="tooltip" data-bs-placement="right" title="This is your current saved E-mail address."><i class="fas fa-circle-question icon"></i></span>-Current E-Mail</div></td>
                <td><div align="left">-{$email}-</div></td>
            </tr>
            <tr>
                <td valign="top"><div class="rowdesc">-<span class="text-info cursor-help me-1" data-bs-toggle="tooltip" data-bs-placement="right" title="Type your password here."><i class="fas fa-circle-question icon"></i></span>-Password</div></td>
                <td><div align="left">
                        <input class="textbox" type="password" id="emailpw" value="" name="emailpw" />
                    </div><div id="emailpw.msg" class="badentry"></div></td>
            </tr>
            <tr>
                <td valign="top"><div class="rowdesc">-<span class="text-info cursor-help me-1" data-bs-toggle="tooltip" data-bs-placement="right" title="Type your new email address here."><i class="fas fa-circle-question icon"></i></span>-New E-mail</div></td>
                <td><div align="left">
                        <input class="textbox" type="text" id="email1" value="" name="email1" />
                    </div><div id="email1.msg" class="badentry"></div></td>
            </tr>
            <tr>
                <td valign="top"><div class="rowdesc">-<span class="text-info cursor-help me-1" data-bs-toggle="tooltip" data-bs-placement="right" title="Please type your new email address again to avoid a mistake."><i class="fas fa-circle-question icon"></i></span>-Confirm E-mail</div></td>
                <td><div align="left">
