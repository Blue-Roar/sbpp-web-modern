  ...
  <div id="add-group1">
    ...
    <tr>
        <td valign="top" width="35%">
          <div class="rowdesc">
            <span class="text-info cursor-help me-1" data-bs-toggle="tooltip" data-bs-placement="right" title="Type the nickname of the person that you are banning."><i class="fas fa-circle-question icon"></i></span>Nickname
          </div>
        </td>
        <td>
          <div align="left">
      ...
      <tr>
        <td valign="top">
          <div class="rowdesc">
            <span class="text-info cursor-help me-1" data-bs-toggle="tooltip" data-bs-placement="right" title="The Steam ID or Community ID of the person to ban."><i class="fas fa-circle-question icon"></i></span>Steam ID / Community ID
          </div>
        </td>
        <td>
          <div align="left">
      ...
      <tr>
        <td valign="top" width="35%">
          <div class="rowdesc">
            <span class="text-info cursor-help me-1" data-bs-toggle="tooltip" data-bs-placement="right" title="Select how long you want to block this person for."><i class="fas fa-circle-question icon"></i></span>Block Length
          </div>
        </td>
        <td>
          <div align="left">
