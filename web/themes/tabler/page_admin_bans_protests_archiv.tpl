        ...
        <table width="100%" cellpadding="0" cellspacing="0">
            ...
            {foreach from=$protest_list_archiv item="protest"}
                <tr id="apid_{$protest.pid}" class="opener5 tbl_out" onmouseout="this.className='tbl_out'" onmouseover="this.className='tbl_hover'">
                    <td class="toggler" style="border-bottom: solid 1px #ccc" height='16'>{if $protest.archiv!=2}<a href="/banlist{if $protest.authid!=""}?advSearch={$protest.authid}&advType=steamid{else}?advSearch={$protest.ip}&advType=ip{/if}" title="Show ban">{$protest.name}</a>{else}<span class="text-muted">ban removed</span>{/if}</td>
                    ...
                    <td style="border-bottom: solid 1px #ccc" height='16'>
                        ...
                        {/if}
                        <a href="/admin?c=bans&o=email&type=p&id={$protest.pid}">Contact</a>
                    </td>
                </tr>
                                ...
                                {if $protest.archiv!=2}
                                    ...
                                    <tr align="left">
                                        ...
                                        <td height="16" class="listtable_1">
                                            {if $protest.authid == ""}
                                                <span class="text-muted">no steamid present</span>
                                            {else}
                                                {$protest.authid}
                                            {/if}
                                        </td>
