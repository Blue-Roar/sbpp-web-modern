            ...
            <table width="90%" style="border-collapse:collapse;" id="group.details" cellpadding="3">
                <tr>
                    <td valign="top" width="35%">
                        <div class="rowdesc">
                            <span class="text-info cursor-help me-1" data-bs-toggle="tooltip" data-bs-placement="right" title="Type the link to a steam community group."><i class="fas fa-circle-question icon"></i></span>Group Link
                        </div>
                    </td>
                    <td>
                        <div align="left">
                ...
                <tr>
                    <td valign="top" width="35%">
                        <div class="rowdesc">
                            <span class="text-info cursor-help me-1" data-bs-toggle="tooltip" data-bs-placement="right" title="Type the reason, why you are going to ban this steam community group."><i class="fas fa-circle-question icon"></i></span>Group Ban Reason
                        </div>
                    </td>
                    <td>
                        <div align="left">
