                ...
                <table width="90%" border="0" style="border-collapse:collapse;" id="group.details" cellpadding="3">
                    <tr>
                        <td valign="top" width="35%">
                            <div class="rowdesc">
                                -<span class="text-info cursor-help me-1" data-bs-toggle="tooltip" data-bs-placement="right" title="This is the name of the player that was blocked."><i class="fas fa-circle-question icon"></i></span>-Player name
                            </div>
                        </td>
                        <td>
                            <div align="left">
                    ...
                    <tr>
                        <td valign="top" width="35%">
                            <div class="rowdesc">
                                -<span class="text-info cursor-help me-1" data-bs-toggle="tooltip" data-bs-placement="right" title="Choose what to block - chat or voice"><i class="fas fa-circle-question icon"></i></span>-Block Type
                            </div>
                        </td>
                        <td>
                            <div align="left">
                    ...
                    <tr>
                        <td valign="top" width="35%">
                            <div class="rowdesc">
                                -<span class="text-info cursor-help me-1" data-bs-toggle="tooltip" data-bs-placement="right" title="Explain in detail, why this block is being made."><i class="fas fa-circle-question icon"></i></span>-Block Reason
                            </div>
                        </td>
                        <td>
                            <div align="left">
                    ...
                    <tr>
                        <td valign="top" width="35%"><div class="rowdesc">-<span class="text-info cursor-help me-1" data-bs-toggle="tooltip" data-bs-placement="right" title="Select how long you want to block this person for."><i class="fas fa-circle-question icon"></i></span>-Block Length</div></td>
                        <td><div align="left">
