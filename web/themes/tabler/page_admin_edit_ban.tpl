                ...
                <table width="90%" border="0" style="border-collapse:collapse;" id="group.details" cellpadding="3">
                    <tr>
                        <td valign="top" width="35%">
                            <div class="rowdesc">
                                -<span class="text-info cursor-help me-1" data-bs-toggle="tooltip" data-bs-placement="right" title="This is the name of the player that was banned."><i class="fas fa-circle-question icon"></i></span>-Player name
                            </div>
                        </td>
                        <td>
                            <div align="left">
                    ...
                    <tr>
                        <td valign="top" width="35%">
                            <div class="rowdesc">
                                -<span class="text-info cursor-help me-1" data-bs-toggle="tooltip" data-bs-placement="right" title="Choose whether to ban by Steam ID or IP address."><i class="fas fa-circle-question icon"></i></span>-Ban Type
                            </div>
                        </td>
                        <td>
                            <div align="left">
                    ...
                    <tr>
                        <td valign="top">
                            <div class="rowdesc">
                                -<span class="text-info cursor-help me-1" data-bs-toggle="tooltip" data-bs-placement="right" title="This is the Steam ID of the player that is banned. You may want to type a Community ID either."><i class="fas fa-circle-question icon"></i></span>-Steam ID
                            </div>
                        </td>
                        <td>
                            <div align="left">
                    ...
                    <tr>
                        <td valign="top" width="35%">
                            <div class="rowdesc">
                                -<span class="text-info cursor-help me-1" data-bs-toggle="tooltip" data-bs-placement="right" title="This is the IP of the player that is banned."><i class="fas fa-circle-question icon"></i></span>-IP Address
                            </div>
                        </td>
                        <td>
                            <div align="left">
                    ...
                    <tr>
                        <td valign="top" width="35%">
                            <div class="rowdesc">
                                -<span class="text-info cursor-help me-1" data-bs-toggle="tooltip" data-bs-placement="right" title="The reason that this player was banned."><i class="fas fa-circle-question icon"></i></span>-Reason
                            </div>
                        </td>
                        <td>
                            <div align="left">
                    ...
                    <tr>
                        <td valign="top" width="35%"><div class="rowdesc">-<span class="text-info cursor-help me-1" data-bs-toggle="tooltip" data-bs-placement="right" title="Select how long you want to ban this person for."><i class="fas fa-circle-question icon"></i></span>-Ban Length </div></td>
                        <td><div align="left">
                    ...
                    <tr>
                        <td valign="top" width="35%"><div class="rowdesc">-<span class="text-info cursor-help me-1" data-bs-toggle="tooltip" data-bs-placement="right" title="Click here to upload a demo with this ban submission."><i class="fas fa-circle-question icon"></i></span>-Upload Demo
                            </div></td>
                        <td><div align="left">
