        ...
        <table width="90%" style="border-collapse:collapse;" id="group.details" cellpadding="3">
            <tr>
                <td valign="top" width="35%">
                    <div class="rowdesc">
                        <span class="text-info cursor-help me-1" data-bs-toggle="tooltip" data-bs-placement="right" title="Type the nickname of the person that you are banning."><i class="fas fa-circle-question icon"></i></span>
                        Nickname
                    </div>
                </td>
                <td>
            ...
            <tr>
                <td valign="top" width="35%">
                    <div class="rowdesc">
                        <span class="text-info cursor-help me-1" data-bs-toggle="tooltip" data-bs-placement="right" title="Choose whether to ban by Steam ID or IP address."><i class="fas fa-circle-question icon"></i></span>
                        Ban Type
                    </div>
                </td>
                <td>
            ...
            <tr>
                <td valign="top">
                    <div class="rowdesc">
                        <span class="text-info cursor-help me-1" data-bs-toggle="tooltip" data-bs-placement="right" title="The Steam ID or Community ID of the person to ban."><i class="fas fa-circle-question icon"></i></span>
            ...
            <tr>
                <td valign="top" width="35%">
                    <div class="rowdesc">
                        <span class="text-info cursor-help me-1" data-bs-toggle="tooltip" data-bs-placement="right" title="Type the IP address of the person you want to ban."><i class="fas fa-circle-question icon"></i></span>
                        IP Address
                    </div>
                </td>
                <td>
            ...
            <tr>
                <td valign="top" width="35%">
                    <div class="rowdesc">
                        <span class="text-info cursor-help me-1" data-bs-toggle="tooltip" data-bs-placement="right" title="Explain in detail, why this ban is being made."><i class="fas fa-circle-question icon"></i></span>
                        Ban Reason
                    </div>
                </td>
                <td>
            ...
            <tr>
                <td valign="top" width="35%">
                    <div class="rowdesc">
                        <span class="text-info cursor-help me-1" data-bs-toggle="tooltip" data-bs-placement="right" title="Select how long you want to ban this person for."><i class="fas fa-circle-question icon"></i></span>
                        Ban Length
                    </div>
                </td>
                <td>
            ...
            <tr>
                <td valign="top" width="35%">
                    <div class="rowdesc">
                        <span class="text-info cursor-help me-1" data-bs-toggle="tooltip" data-bs-placement="right" title="Click here to upload a demo with this ban submission."><i class="fas fa-circle-question icon"></i></span>
                        Upload Demo
                    </div>
                </td>
                <td>
