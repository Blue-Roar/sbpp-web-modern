                ...
                <table width="99%" cellspacing="0" cellpadding="0" align="center">
                    ...
                    {foreach from=$admins item="admin"}
                        <tr onmouseout="this.className='tbl_out'" onmouseover="this.className='tbl_hover'" class="tbl_out opener">
                            <td class="listtable_1" style="padding:3px;">{$admin.user} (<a href="/banlist?advSearch={$admin.aid}&advType=admin" title="Show bans">{$admin.bancount} bans</a> | <a href="/banlist?advSearch={$admin.aid}&advType=nodemo" title="Show bans without demo">{$admin.nodemocount} w.d.</a>)</td>
                                                ...
                                                <div class="ban-edit">
                                                    <ul>
                                                        {if $permission_editadmin}
                                                            <li>
                                                                <a href="/admin?c=admins&o=editdetails&id={$admin.aid}"><i class="fas fa-clipboard-list fa-lg"></i> Edit Details</a>
                                                            </li>
                                                            <li>
                                                                <a href="/admin?c=admins&o=editpermissions&id={$admin.aid}"><i class="fas fa-subscript fa-lg"></i> Edit Permissions</a>
                                                            </li>
                                                            <li>
                                                                <a href="/admin?c=admins&o=editservers&id={$admin.aid}"><i class="fas fa-server fa-lg"></i> Edit Server Access</a>
                                                            </li>
                                                            <li>
                                                                <a href="/admin?c=admins&o=editgroup&id={$admin.aid}"><i class="fas fa-users fa-lg"></i> Edit Groups</a>
                                                            </li>
                                                        {/if}
